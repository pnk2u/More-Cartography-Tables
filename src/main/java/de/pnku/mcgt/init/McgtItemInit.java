...
public class McgtItemInit {
    ...
    public static final BlockItem PALE_OAK_CARTOGRAPHY_TABLE_I = itemFromBlock(PALE_OAK_CARTOGRAPHY_TABLE);
    ...
    public static void registerItems() {
        ...
        registerItem(PALE_OAK_CARTOGRAPHY_TABLE_I, ACACIA_CARTOGRAPHY_TABLE_I);
        registerItem(MANGROVE_CARTOGRAPHY_TABLE_I, PALE_OAK_CARTOGRAPHY_TABLE_I);
